...
const LoginPage = () => {
  ...
  // controll handle submit function
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        ...
        <div className="text-center">
          <p className="text-base-content/60">Dont have a account
      ...
      <ImagePattern 
        title={"welcome back"}
        subtitle={"sign in to continue your Account bro ! and be happy"}
      />  
    </div>
  )
}
